...
function fn_boardDetail(boardNum){
	document.profileSomeoneForm.boardNum.value = boardNum;
	document.profileSomeoneForm.action = "/main/boardDetail";
	document.profileSomeoneForm.submit();
}
		...
		<section class="section-img">
		    <div class="profile-image-container">
		       ...
		       <div style="margin-left: 60px; display: flex; flex-direction: column; justify-content: space-between;">
				...
				<div>
					<button id="changeImg" class="button-img" onclick="fn_toggleFollow(this, '${someId}')" style="margin-left:100px;">팔로우</button>
				</div>
	        ...
	        <td>
           		<div class="boardImg-container">
	            	...
	            	<div class="overlay" onclick="fn_boardDetail(${insBoard.boardNum})">
                   		<div class="heart-icon">❤︎ <div class="numberr">28</div> 🗨️ <div class="numberr">${insBoard.commentCnt}</div> </div>
               		</div>
	            </div>
	        </td>
...
$(document).ready(function() {
	...
	$("#follow-list-close").on("click", function(){
		...
		document.profileSomeoneForm.action = "/main/profileSomeone";
		document.profileSomeoneForm.submit();
	});
...
<form id="profileSomeoneForm" name="profileSomeoneForm" method="post">
	<input type="hidden" id="someId" name="someId" value="${someId}" />
